                ...
                <template v-for="(item, index) in dates">
                    <div class="slider"
                        ...
                        <div class="day" v-for="day in getDaies(item.date)">
                            <div :data-val="day.date"
								@click.stop="dayClickHandle($event,day.date)"
...
<style scoped>
.year_str{
    height: 36px; border-bottom: #192230 solid 1px; line-height: 36px; text-align: center;color:#7887a6;
}
.week-slider{
  width: 100%;
  height: 68px;
...
.week-slider .sliders .day{
  flex: 1;
}
.week-slider .sliders .day div{
  height: 48px; width: 48px; padding: 6px 0; margin: auto; text-align: center; line-height: 18px; font-size: 12px; border-radius: 50%;
}
.week-slider .sliders .day div.on{
